...
st.set_page_config(page_title="هيــثم | @UYIITY00", page_icon="⚔️", layout="centered")
...
st.markdown("<h1 style='text-align: center; color: #FFD700;'>هـيـــثم | UYIITY00</h1>", unsafe_allow_html=True)
...
st.write("---")
st.markdown("<p style='text-align: center; font-size: 12px; color: #555;'>تم التطوير بواسطة هيثم @UYIITY00</p>", unsafe_allow_html=True)
